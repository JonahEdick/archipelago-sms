...
DELFINO_PLAZA: SmsRegion = SmsRegion(
    ...
    shines=[
        Shine(
            ...
            requirements=[Requirements(SPRAY_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER, skip_forward=True)],
            hard=[Requirements(SPRAY_OR_HOVER_OR_TURBO), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER_OR_TURBO, skip_forward=True)],
            in_game_bit=117,
        ),
        Shine(
            "Clean the West Bell",
            requirements=[Requirements([[NozzleType.hover]]), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(HOVER_AND_YOSHI, skip_forward=True)],
            hard=[Requirements(SPRAY_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER, skip_forward=True)],
        ...
        Shine(
            "Clean the East Bell",
            requirements=[Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER), Requirements(ROCKET_AND_YOSHI, shines=5),
                Requirements(ROCKET_AND_SPLASHER, skip_forward=True)],
            hard=[Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER_OR_YOSHI, skip_forward=True)],
            advanced=[
                Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER_OR_YOSHI, skip_forward=True),
                Requirements(SPRAY_AND_TURBO),
            ],
            in_game_bit=97,
        ...
        Shine(
            ...
            requirements=[Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER), Requirements(ROCKET_AND_YOSHI, shines=5),
                Requirements(ROCKET_AND_SPLASHER, skip_forward=True)],
            hard=[Requirements(ROCKET_AND_ANY_FLUDD), Requirements(ROCKET_AND_YOSHI, shines=5),
                Requirements(ROCKET_AND_ANY_NOZZLE, skip_forward=True)],
            advanced=[
                Requirements(ROCKET_AND_SPRAY_OR_ROCKET_AND_HOVER), Requirements(ROCKET_AND_YOSHI, shines=5),
                Requirements(ROCKET_AND_SPLASHER, skip_forward=True),
                Requirements(SPRAY_AND_TURBO),
            ],
            in_game_bit=99,
        ...
        Shine(
            "Lily Pad Ride",
            requirements=[Requirements(ALL_SPLASHERS, shines=5), Requirements(ALL_SPLASHERS, skip_forward=True)],
            advanced=[Requirements(SPRAY_AND_YOSHI, shines=5), Requirements(SPRAY_AND_YOSHI, skip_forward=True)],
            tears=[Requirements()],
            in_game_bit=91,
        ),
        Shine(
        ...
        Shine(
            ...
            advanced=[Requirements(SPRAY_AND_ANY_FLUDD), Requirements(SPRAY_AND_YOSHI, shines=5),
                Requirements(SPRAY_AND_ANY_NOZZLE, skip_forward=True)],
    ...
    blue_coins=[
        ...
        BlueCoin("Tower M",
            requirements=[Requirements(SPRAY_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER, skip_forward=True)], in_game_bit=126),
        BlueCoin(
            "Chuckster Room M",
            requirements=[Requirements(SPRAY_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER, skip_forward=True)],
        ...
        BlueCoin(
            ...
            advanced=[Requirements([[NozzleType.hover]]), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(HOVER_OR_YOSHI, skip_forward=True)],
            in_game_bit=133,
        ),
        BlueCoin(
            "Jail Cell",
        ...
        BlueCoin(
            ...
            requirements=[Requirements([[NozzleType.yoshi]], shines=5), Requirements([[NozzleType.yoshi]], skip_forward=True)],
            tears=[Requirements(ROCKET_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ROCKET_OR_HOVER_OR_YOSHI, skip_forward=True)],
            in_game_bit=135,
        ),
        ...
        BlueCoin(
            ...
            requirements=[Requirements([[NozzleType.spray]]), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(SPRAY_OR_YOSHI, skip_forward=True)],
            advanced=[Requirements(SPRAY_OR_HOVER), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(ANY_SPLASHER, skip_forward=True)],
            tears=[Requirements(SPRAY_OR_HOVER_OR_TURBO), Requirements([[NozzleType.yoshi]], shines=5),
                Requirements(skip_forward=True)],
            in_game_bit=138,
        ),
        BlueCoin(
        ...
        BlueCoin(
            "Pineapple Basket",
            requirements=[Requirements(SPRAY_OR_HOVER), Requirements(skip_forward=True)],
            hard=[Requirements(SPRAY_OR_HOVER_OR_TURBO), Requirements(skip_forward=True)],
            in_game_bit=128,
        ),
        BlueCoin(
            "Durian Basket",
